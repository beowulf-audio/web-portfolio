#!/bin/bash
# Helper script to push Beowulf Audio using PAT token
# Usage: ./git-push.sh [branch]
# Default branch: main

BRANCH="${1:-main}"
REPO_URL="github.com/beowulf-audio/web-portfolio.git"
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    echo "🚀 Check build status: https://github.com/beowulf-audio/web-portfolio/actions"
else
